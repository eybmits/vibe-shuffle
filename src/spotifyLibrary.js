...
// The fixed study pool: real Spotify tracks with embedded audio features,
// balanced across the four valence/arousal quadrants.
// Needs no Spotify library API — playback uses the connected Web Playback SDK.
export function buildStudyLibrary() {
  return STUDY_TRACKS.map((track) => {
